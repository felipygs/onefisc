 ...
 * UF from the key itself), so UF never selects the URL — it only fills the
 * informational cUFAutor/timezone, and Client has no UF column to derive it
 * from (adding one is out of scope).
 */
