...
import { index as clientsIndex, update } from '@/routes/clients';
...
const form = useForm({
    ...
    razao_social: props.client.razao_social,
    regime: props.client.regime,
    contador_responsavel: props.client.contador_responsavel,
});
...
function onSubmit() {
    form.put(update.url({ client: props.client.id }));
}
</script>

<template>
    <Head title="Editar client" />

    <div class="flex flex-col gap-6 p-4">
        <div>
            <h1 class="text-xl font-semibold">Editar client</h1>
